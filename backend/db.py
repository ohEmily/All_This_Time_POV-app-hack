...
COLLECTIONS = [LAUGH_TERM, CRY_TERM, THINK_TERM, TEMPERATURE_TERM, PRESIDENT_TERM, NUMBER1_TERM, TOP_NEWS_TERM, TELEVISION_TERM, WONDERFUL_LIFE_TERM, RUN_TERM, ALONE_TERM, FATHER_TERM, SNOWFLAKES_TERM, COLD_TERM, REPRESENTS_TERM]
